...
export function getToolsByCategory(category: string): Tool[] {
  const categories: Record<string, string[]> = {
    filesystem: ["read_file", "write_file", "list_directory", "delete_file", "move_file", "copy_file", "create_directory", "get_file_info", "search_files", "watch_file", "get_file_permissions", "set_file_permissions"],
    git: ["git_status", "git_commit", "git_push", "git_pull", "git_branch", "git_log", "git_diff", "git_checkout", "git_merge", "git_tag"],
    database: ["db_query", "db_insert", "db_update", "db_delete", "db_create_table", "db_drop_table", "db_list_tables", "db_get_schema", "db_begin_transaction", "db_commit", "db_rollback", "db_backup"],
    http: ["http_get", "http_post", "http_put", "http_delete", "parse_html", "download_file", "check_url_status", "fetch_json_api", "set_http_timeout", "follow_redirects"],
    data: ["parse_json", "parse_csv", "parse_xml", "convert_format", "validate_schema", "transform_data", "merge_objects", "filter_array"],
    system: ["get_system_info", "monitor_cpu", "monitor_memory", "monitor_disk", "list_processes", "kill_process", "get_network_stats", "check_service_status"],
  };
